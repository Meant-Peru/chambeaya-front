...
export default function ListPost() {
  // Verificando el token de sesion:
  ...
  const { id } = useParams();
  const {
    postJobSate: { loading, postJob, postulants },
  } = usePostJob(id);
  const _postJob = postJob!.reduce(
    (k: any, o: any) => ((k[o] = k), o),
    {}
  ) as PostJob;
        ...
        <section className="DetailPostComponent">
          ...
          <aside className="cardApply mt-5">
            ...
            <article className="infoApply">
              <h4>
                {postulants > 0
                  ? postulants + " personas aplicaron"
                  : "Ninguna persona ha aplicado aún"}
              </h4>

              <p className="mt-2">{createDateFormat(_postJob.createdDate)}</p>
            </article>
            <article className="actionApply">
              {sesionLog == null ? (
				<>
				<BtnPrimary onClick={handleRedirect}> Iniciar Sesión </BtnPrimary>

				<p className="mt-2" style={{ color: "red" }}>
                  Debes loguearte para aplicar.
                </p>
				</>
              ...
              {get(_postJob, "state", "") ? (
                ...
                <p className="mt-2">
                  El puesto de trabajo ya fue tomado por alguien más
                </p>
              )}
            </article>
          </aside>
          ...
          >
            ...
            <p className="mt-2 text-center">
              <i>
                * Recuerde que el presupuesto estimado por el cliente es de :{" "}
                {get(_postJob, "salaryRange", "")} soles
              </i>
            </p>
          </Modal>
          ...
          <aside className="detailsApply mt-5 mb-5">
            ...
            <article className="rightBox">
              ...
              <ul>
                ...
                <li>
                  Presupuesto estimado: S/ {get(_postJob, "salaryRange", "")}
                </li>
